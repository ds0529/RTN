...
def evaluate(num_votes):
    ...
    # dgcnn_model_path = 'result/log_so3_rotation/trained_models/epoch_200.ckpt'
    ...
    for t in range(try_num):
        ...
        for fn in range(num_test_file):
            ...
            if part:
                ...
                current_label = ops['tset_label'][fn]
                ...
                current_data = np.concatenate(class_data, axis=0)
            else:
                current_data = ops['test_data'][fn]
