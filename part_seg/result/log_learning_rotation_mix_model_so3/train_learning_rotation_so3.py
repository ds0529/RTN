...
parser.add_argument('--log_dir', default='result/log_learning_rotation_so3_30_30', help='Log dir [default: log]')
...
hdf5_data_dir = '/mnt/dengshuang/data/shapenet50/shapenet_hdf5_data'
