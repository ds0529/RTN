...
parser.add_argument('--log_dir', default='result/log_rotation_pretrain_mix_model_dgcnn_so3', help='Log dir [default: log]')
...
def train_one_epoch(sess, ops, train_writer):
    ...
    for fn in range(len(TRAIN_FILES)):
        ...
        for batch_idx in range(num_batches):
            ...
            rotated_data[:, :, :3] = provider.jitter_point_cloud(rotated_data[:, :, :3])

            # get rotated data
            feed_dict = {ops['pointclouds_origin_pl']: rotated_data[:, :, :3],
